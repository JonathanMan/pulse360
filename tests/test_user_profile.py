...
class TestGetNavPages:
    ...
    def test_macro_pulse_visible_to_all(self):
        for profile in PROFILES:
            st.session_state["pie360_profile"] = profile
