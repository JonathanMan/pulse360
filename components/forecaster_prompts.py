"""
components/forecaster_prompts.py
==================================
Claude API prompt logic for the Pie360 forecaster feature (Macro Pulse page).

Centralising these prompts makes them easy to version, test, and reuse.
This module is the single source of truth for forecaster signal refresh,
deep-dive briefs, and portfolio review copy.

Public API
----------
    from components.forecaster_prompts import (
        REFRESH_PROMPT,
        build_review_prompt,
        run_deep_dive,
        stream_review,
